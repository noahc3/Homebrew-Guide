...
1. Reboot into Hekate with PegaScape if you haven't already.
2. In Hekate, tap **'Tools > Backup eMMC > eMMC BOOT0 & BOOT1'**
...
8. Select **Payloads > Lockpick_RCM.bin** (if you do not have this payload, you can obtain it `from GitHub <https://github.com/shchmue/Lockpick_RCM/releases/>`_ and place it at **sd:/bootloader/payloads/lockpick_RCM.bin** ).
