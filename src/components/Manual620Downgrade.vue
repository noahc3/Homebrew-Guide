    ...
    <div class="ui container">
        <div class="ui segment" v-bind:class="{ inverted: $root.$data.darkTheme }">
            <h1 class="ui header" style="text-align:center">
                Downgrading Manually from Firmware 6.2.0 to Any Firmware
            </h1>
        ...
        <div class="ui red message" v-bind:class="{ inverted: $root.$data.darkTheme }">
            ...
            <div class="ui divider"></div>
            <p>This guide is only for users who do not have a working NAND backup created before firmware 6.2.0. <b style="color:red">If you have a working NAND backup, restore that with Hekate instead</b> (the side-effects listed above will still apply).</p>
        </div>
        ...
        <div class="ui segment" v-bind:class="{ inverted: $root.$data.darkTheme }">
            ...
            <ol>
                ...
                <li>Download <a href="https://paste.ee/d/b533j/0">keys.txt</a></li>
                <li>Put <b>keys.txt</b> into the ChoiDujour folder</li>
                <li>Go to <a href="https://darthsternie.bplaced.net/switch.html">darthsternie.bplaced.net/switch</a></li>
                <li>Download the .ZIP file for the system firmware version you want to downgrade to
                ...
                <li>Extract the contents of the downloaded .ZIP file to the newly created <b>"fw"</b> folder</li>
