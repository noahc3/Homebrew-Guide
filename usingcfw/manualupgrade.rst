...
8. If you are downgrading over multiple system versions you should consider selecting **Reset to factory settings**. This will erase all save data. Otherwise select **Preserve settings**.
