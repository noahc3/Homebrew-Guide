...
3. Push the Hekate payload to your Switch
...
.. warning::
    Shutting down the Switch from Horizon after booting with AutoRCM **will not turn off the Switch!** You must choose **'Power Off'** from Hekate to properly shutdown the Switch. Not doing so will leave your Switch in RCM, slowing draining battery.
...
7. Go back to the main menu and select **'Power Off'**
